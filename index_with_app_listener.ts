...
const db = new aws.rds.Instance("postgresdb", { // 52.78 USD/month
  engine: "postgres",
...
const schedulerImage = new awsx.ecr.Image("webserver", { repositoryUrl: repo.repositoryUrl, path: "./airflow-container" })
